...
const restaurantsData = [
  ...
  },
  {
    ...
    mapLink: 'https://maps.app.goo.gl/HQatfQXqCtn9ZRSY8'
  },
  {
    id: 'gatox',
    name: 'Gatox',
  ...
  return (
    <section className="py-24 bg-pearl relative overflow-hidden group/section z-20">
      <div className="max-w-[1400px] mx-auto px-6 relative">
        ...
        <button 
          onClick={() => scroll('left')}
          className="hidden md:flex absolute left-2 top-[60%] -translate-y-1/2 w-12 h-12 bg-white backdrop-blur-md rounded-full items-center justify-center text-navy shadow-xl border border-navy/5 hover:bg-gold hover:text-white transition-all z-20 opacity-0 group-hover/section:opacity-100 disabled:opacity-0"
        >
          <ChevronLeft className="w-6 h-6" />
        </button>
        <button 
          onClick={() => scroll('right')}
          className="hidden md:flex absolute right-2 top-[60%] -translate-y-1/2 w-12 h-12 bg-white backdrop-blur-md rounded-full items-center justify-center text-navy shadow-xl border border-navy/5 hover:bg-gold hover:text-white transition-all z-20 opacity-0 group-hover/section:opacity-100 disabled:opacity-0"
        >
