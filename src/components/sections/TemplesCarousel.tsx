...
const templesData = [
  {
    id: 'iskcon',
    name: 'ISKCON Temple',
    image: 'https://1zn1w7lqhv0bhjja.public.blob.vercel-storage.com/rooms/iskcon.png'
  },
  {
    id: 'rushikonda-venkateswara',
    name: 'Rushikonda Venkateswara',
    image: 'https://1zn1w7lqhv0bhjja.public.blob.vercel-storage.com/rooms/rushikonda%20Venkateswara%20swami%20temple.png'
  },
  {
    id: 'simhachalam',
    name: 'Simhachalam Temple',
    image: 'https://1zn1w7lqhv0bhjja.public.blob.vercel-storage.com/rooms/simhachalam.png'
  }
];

export const TemplesCarousel = ({ onRouteSelect }: { onRouteSelect?: (route: {name: string, dest: string}) => void }) => {
  ...
  return (
    <section className="py-12 bg-navy relative overflow-hidden group/section z-20">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end gap-6 mb-12">
          ...
          >
            <div className="flex items-center gap-4 mb-4">
              ...
              <span className="font-body text-caption tracking-[0.2em] uppercase text-gold">Spiritual Journey</span>
            </div>
            <h2 className="font-display text-heading-xl text-pearl">Sacred Temples of Vizag</h2>
          </motion.div>
        </div>
            ...
            >
              <div className="group relative h-[450px] overflow-hidden rounded-sm bg-navy flex">
                ...
                <div className="absolute bottom-0 left-0 p-8 w-full z-10 flex flex-col justify-end">
                  <h3 className="font-display text-heading-md text-pearl mb-4">{temple.name}</h3>
                  <button 
                    onClick={() => onRouteSelect?.({ name: temple.name, dest: temple.name + ', Visakhapatnam' })}
