  ...
  return (
    <section className="py-24 bg-pearl relative overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-6">
        ...
        {/* Carousel */}
        <div className="flex overflow-x-auto gap-8 pb-12 snap-x snap-mandatory scrollbar-hide hide-scroll-bar" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
          {attractionsData.map((attraction, index) => (
            ...
            >
              <div className="group relative h-[450px] overflow-hidden rounded-sm bg-navy">
                <img 
