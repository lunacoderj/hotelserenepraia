  ...
  return (
    <section className="py-24 bg-pearl relative overflow-hidden group/section">
      <div className="max-w-[1400px] mx-auto px-6 relative">
        ...
        <button 
          onClick={() => scroll('left')}
          className="flex absolute left-2 md:left-4 top-[55%] md:top-[60%] -translate-y-1/2 w-10 h-10 md:w-12 md:h-12 bg-white/80 backdrop-blur-md rounded-full items-center justify-center text-navy shadow-xl border border-navy/10 hover:bg-gold hover:text-white transition-all z-20 opacity-100 lg:opacity-0 lg:group-hover/section:opacity-100 disabled:opacity-0"
        >
          <ChevronLeft className="w-5 h-5 md:w-6 md:h-6" />
        </button>
        <button 
          onClick={() => scroll('right')}
          className="flex absolute right-2 md:right-4 top-[55%] md:top-[60%] -translate-y-1/2 w-10 h-10 md:w-12 md:h-12 bg-white/80 backdrop-blur-md rounded-full items-center justify-center text-navy shadow-xl border border-navy/10 hover:bg-gold hover:text-white transition-all z-20 opacity-100 lg:opacity-0 lg:group-hover/section:opacity-100 disabled:opacity-0"
        >
